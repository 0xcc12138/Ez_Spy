...
public:
	explicit m_Window(QWidget* parent = nullptr)
		...
		connect(ui.pushButton, &QPushButton::clicked, this, &m_Window::FileSpyClicked);

		connect(ui.pushButton_4, &QPushButton::clicked, this, &m_Window::CmdSpyClicked);

		connect(ui.pushButton_2, &QPushButton::clicked, this, &m_Window::KeyboardSpyClicked);
	}
...
private slots:
	...
	void FileSpyClicked();//创建文件监控

	void CmdSpyClicked();  //开启Cmd指令监控

	void KeyboardSpyClicked();  //开启Cmd指令监控
};